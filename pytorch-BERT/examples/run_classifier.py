...
class FortyProcessor(DataProcessor):
    """Processor for the CoLA data set (GLUE version)."""
    ...
    def get_labels(self):
        """See base class."""
        return [str(n) for n in range(40)]
...
def main():
    ...
    # Dont forget to update the metrics too!
    processors = {
        "cola": ColaProcessor,
        "mnli": MnliProcessor,
    ...
    ### I fixed this because it only runs evaluation if you train first!
    if True:
